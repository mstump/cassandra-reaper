...
//    try{
      ...
      InputStream is = ReaperCassandraIT.class.getResource("/db/reaper_cassandra_db.cql").openStream();
      String cql;
      try(Reader reader = new InputStreamReader(is)) {
        cql = CharStreams.toString(reader);
      }
      
      Session session = cluster.connect("reaper_db");
